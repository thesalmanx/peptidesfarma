        ...
        <div style={{ border: "1px solid var(--pf-line)", borderRadius: 16, padding: 16, overflow: "visible" }} className="md:p-[30px] flex flex-col md:flex-row md:items-start gap-6 md:gap-8 lg:gap-10">
          ...
          <div className="flex-1 flex flex-col w-full md:w-1/2 pt-6 md:pt-2">
            ...
            <div style={{ borderTop: "1px solid var(--pf-line)", paddingTop: 20 }}>
              ...
              <div ref={ctaRef} style={{ display: "flex", gap: 10, alignItems: "center", height: 56 }}>
                <div style={{ display: "inline-flex", alignItems: "center", border: "2px solid var(--pf-ink)", borderRadius: 10, height: 56, flexShrink: 0 }}>
                  <button onClick={() => setQty(Math.max(1, qty - 1))} style={{ width: 44, height: 52, border: "none", background: "transparent", display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
                  ...
                  <button onClick={() => setQty(Math.min(99, qty + 1))} style={{ width: 44, height: 52, border: "none", background: "transparent", display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}>
                ...
                <button disabled={outOfStock || adding} onClick={handleAdd} className="pf-btn pf-btn--primary" style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, flex: 1, height: 56, borderRadius: 10, cursor: adding ? "wait" : "pointer", transition: "all 200ms ease", ...(addError ? { background: "#ef4444" } : added ? { background: "#16a34a" } : {}) }}>
                  {adding ? (
                ...
                <button
                  ...
                  style={{ width: 56, height: 56, flexShrink: 0, borderRadius: 10, border: "2px solid var(--pf-ink)", background: "#fff", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", transition: "all 180ms ease" }}
                >
