    ...
    <div className="md:hidden">
      ...
      >
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <line x1="4" y1="5" x2="20" y2="5" stroke="var(--pf-ink)" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="4" y1="12" x2="20" y2="12" stroke="var(--pf-ink)" strokeWidth="1.5" strokeLinecap="round" />
          <line x1="4" y1="19" x2="20" y2="19" stroke="var(--pf-ink)" strokeWidth="1.5" strokeLinecap="round" />
        </svg>
      </button>
