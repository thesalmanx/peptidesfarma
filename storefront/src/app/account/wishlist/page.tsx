    ...
    <div className="w-full max-w-[1280px] flex flex-col gap-4">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 px-6 border border-[#E0E0E0] rounded-[24px]">
          ...
          <p className="text-[16px] font-semibold text-[#242424] mb-1">Your wishlist is empty</p>
          <p className="text-[14px] text-[#595959] mb-4">Save items you love to your wishlist.</p>
          <Link
            href="/products"
            className="inline-flex items-center justify-center px-6 py-3 h-[40px] rounded-[110px] bg-[#242424] text-[14px] font-bold leading-[24px] tracking-[-0.01em] text-white"
          >
            Browse products
          </Link>
        </div>
